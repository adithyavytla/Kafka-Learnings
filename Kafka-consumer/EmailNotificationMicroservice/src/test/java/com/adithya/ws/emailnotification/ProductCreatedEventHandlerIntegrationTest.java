package com.adithya.ws.emailnotification;
...
import com.adithya.ws.emailnotification.handler.ProductCreatedEventHandler;
...
public class ProductCreatedEventHandlerIntegrationTest {
	...
	public void testProductCreatedEventHandler_OnProductCreated_HandlesEvent() throws Exception{
		...
		verify(productCreatedEventHandler, timeout(6000).times(1)).handle(eventCaptor.capture(), 
